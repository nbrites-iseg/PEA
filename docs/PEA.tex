...
\subsection{Distribuição estacionária e distribuição limite}\label{distribuicao-estacionaria-e-distribuicao-limite}
...
\subsection{\texorpdfstring{Comportamento limite de \(P_{ij}^n\) quando \(n\to+\infty\)}{Comportamento limite de P\_\{ij\}\^{}n quando n\textbackslash to+\textbackslash infty}}\label{comportamento-limite-de-p-ij-n-quando-n-to-infty}
